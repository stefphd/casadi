...
namespace casadi {
  ...
  public:
    ...
    static void separate_linear(const MatType &expr, const MatType &sym_lin, const MatType &sym_const,
                  MatType& SWIG_OUTPUT(expr_const), MatType& SWIG_OUTPUT(expr_lin), MatType& SWIG_OUTPUT(expr_nonlin));
    /** @}  */
    /// \endcond
